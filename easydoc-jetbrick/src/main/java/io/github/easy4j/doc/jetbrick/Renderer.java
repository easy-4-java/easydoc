...
/**
 * Stateless renderer that delegates to the Jetbrick {@link JetEngine} to
...
public final class Renderer {
     ...
     * @param engine    the Jetbrick engine to use
     * @return the rendered output
     */
    public String render(String template, Map<String, Object> variables, JetEngine engine) throws Exception {
