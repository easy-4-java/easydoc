...
public interface VariableReplacer {
     ...
     *
     * <p>On JDK 17 (the 2.0.x baseline), the fallback logic never triggers
     * because {@code Runtime.version().feature()} returns 17, which is less
     * than 21. The code is retained for forward-compatibility.
     */
