...
维护策略（2026-08-28 更新）：**1.0.x 处于受限维护的 EOL 路径**——该线锁定 docx4j 8.3.15
（javax 终线，CVE-2026-53752 无上游修复），**请勿用于处理不可信文档**；不可信输入请使用
2.0.x 或 3.0.x。1.0.x 仍适用于 JDK 8 下基于可信内部模板的文档生成，且仅为我们自行引入的
缺陷提供修复。新功能与安全加固优先落地 2.0.x / 3.0.x，仅当可干净适配 javax 基线时才回移。
