...
class WordprocessingMLThymeleafRenderPerfTest {
    ...
    void processHelloTemplateEndToEndUnderBound() throws Exception {
        ...
        LOG.debug("thymeleaf process {} end-to-end: {} ms median over {} renders", TEMPLATE, medianMillis, PROCESS_MEASURED);
        assertTrue(medianMillis < MAX_MEDIAN_PROCESS_MILLIS,
                "thymeleaf process median " + medianMillis + " ms exceeded bound "
